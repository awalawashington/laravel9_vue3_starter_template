...
export default function useUsers() {
    ...
    const submitEmail = async (c, data) => {
        errors.value = ''
        try {
            const {data:response} = await axios.post('/admin/password/email', data)
    ...
    const submitCode = async (c, data) => {
        errors.value = ''
        try {
            const {data:response} = await axios.post('/admin/password/code', data)
    ...
    const passwordReset = async (c, data) => {
        errors.value = ''
        try {
            const {data:response} = await axios.put('/admin/password/reset', data)
