@extends('layouts.admin.app')
    ...
    @section('content')
                        ...
                        <div class="col-lg-3">
                            <div class="card card-eco">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <h3 class="font-weight-bold">$1590</h3>
                                    ...
                                    <div id="carousel_2" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <div class="media">
                                                    <img src="{{ asset('admin/assets/images/products/img-2.png') }}" height="200" class="mr-4" alt="...">
                                            ...
                                            <div class="carousel-item">
                                                <div class="media">
                                                    <img src="{{ asset('admin/assets/images/products/img-3.png') }}" height="200" class="mr-4" alt="...">
                                                    <div class="media-body align-self-center"> 
                                            ...
                                            <div class="carousel-item">
                                                <div class="media">
                                                    <img src="{{ asset('admin/assets/images/products/img-1.png') }}" height="200" class="mr-4" alt="...">
                                                    <div class="media-body align-self-center"> 
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>                                                                
                                                        <img src="{{ asset('admin/assets/images/flags/us_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img class="" src="{{ asset('admin/assets/images/products/img-2.png') }}" alt="user"> </td>
                                                    <td>
                                                        Watch
                                                    </td>
                                                    <td>                                                                
                                                        <img src="{{ asset('admin/assets/images/flags/french_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img class="" src="{{ asset('admin/assets/images/products/img-3.png') }}" alt="user"> </td>
                                                    <td>
                                                        Headphone
                                                    </td>
                                                    <td>                                                                
                                                        <img src="{{ asset('admin/assets/images/flags/spain_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img class="" src="{{ asset('admin/assets/images/products/img-4.png') }}" alt="user"> </td>
                                                    <td>
                                                        Purse
                                                    </td>
                                                    <td>                                                                
                                                        <img src="{{ asset('admin/assets/images/flags/russia_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>                                                                
                                                        <img src="{{ asset('admin/assets/images/flags/italy_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img class="" src="{{ asset('admin/assets/images/products/img-6.png') }}" alt="user"> </td>
                                                    <td>
                                                        Boll
                                                    </td>
                                                    <td>                                                                
        ...
        <script src="{{ asset('admin/assets/pages/jquery.eco_dashboard.init.js') }}"></script>
