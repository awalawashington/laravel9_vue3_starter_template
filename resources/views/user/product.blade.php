                                        ...
                                        <div class="col-lg-6 align-self-center">
                                            <div class="single-pro-detail">
                                                ...
                                                <div class="quantity mt-3 ">
                                                    ...
                                                    <a href="" class="btn btn-primary text-white px-4 d-inline-block"><i class="mdi mdi-cart mr-2"></i>Add to Cart</a>
                                                </div>                                             
                                            </div>
                                        </div><!--end col-->                                            
                                    </div><!--end row-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="newsletters-text">
                                                ...
                                                <p class="text-muted mb-0">It is a long established fact that 
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-3 align-self-center">
                                            <img src="../assets/images/products/2.jpg" alt="" height="250" class="d-block mx-auto">
                                        </div>
                                        <div class="col-lg-9">
                                            <span class="bg-soft-danger rounded-pill px-3 py-1 font-weight-bold">Metrica</span>
                                            <h5 class="mt-3">It is a long established fact that a reader will be distracted</h5>
                                            <p class="text-muted mb-4">There are many variations of passages of Lorem Ipsum available, 
