                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Dice</a></li>
                    ...
                    <div class="row">                        
                        <div class="col-lg-3">
                            <div class="card e-co-product">
                                ...
                                <div class="card-body product-info">
                                    <a href="{{ route('user.product') }}" class="product-title">Unique Bag (Gray)</a>
                        ...
                        <div class="col-lg-3">
                            <div class="card e-co-product">
                                ...
                                <div class="card-body product-info">
                                    <a href="{{ route('user.product') }}" class="product-title">Headphone F2019</a>
                                    <div class="d-flex justify-content-between my-2">
                        ...
                        <div class="col-lg-3">
                            <div class="card e-co-product">
                                ...
                                <div class="card-body product-info">
                                    <a href="{{ route('user.product') }}" class="product-title">Lavie Purse CN120</a>
                                    <div class="d-flex justify-content-between my-2">
                        ...
                        <div class="col-lg-3">
                            <div class="card e-co-product ">
                                ...
                                <div class="card-body product-info">
                                    <a href="{{ route('user.product') }}" class="product-title">Nike Shoes Leather Pasted 20</a>
                                    <div class="d-flex justify-content-between my-2">
                    ...
                    <div class="row">                        
                        <div class="col-lg-3">
                            <div class="card e-co-product">
                                ...
                                <div class="card-body product-info">
                                    <a href="{{ route('user.product') }}" class="product-title">Cosco Footboll <small class="text-muted">size-04</small></a>
                                    <div class="d-flex justify-content-between my-2">
                                        <p class="product-price">$29.00 <span class="ml-2"><del>$49.00</del></span></p>
                                        <ul class="list-inline mb-0 product-review align-self-center">
                                            <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
